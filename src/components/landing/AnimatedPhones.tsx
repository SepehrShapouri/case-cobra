...
interface AnimatedPhoneProps extends HTMLAttributes<HTMLDivElement> {
  imgSrc: string;
}
function AnimatedPhoneColumn({
  phones,
  className,
  phoneClassName,
  msPerPixel = 0,
...
function AnimatedPhone({ imgSrc, className, ...props }: AnimatedPhoneProps) {
