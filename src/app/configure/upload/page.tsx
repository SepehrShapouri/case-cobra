...
function page() {
  ...
  return (
    <div
      className={cn(
        "relative h-full flex-1 my-16 w-full rounded-xl bg-gray-900/5 p-2 cursor-pointer ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl flex justify-center flex-col items-center",
        {
            ...
            >
              ...
              <div className="flex flex-col justify-center mb-2 text-sm text-zinc-500">
                {isUploading ? (
                  ...
                  <p>
                    <span className="font-bold">Drop file </span>
                    to upload
                  </p>
                ) : (
                  <p>
